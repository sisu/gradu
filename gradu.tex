...
\Ensure Copy \hasbita{t} to \hasbita{\leftu{t}{a}} and to \hasbita{\rightu{t}{a}} for all nodes $t$ that can be accessed from $s$ by moving along axes $1\dots d$.
...
\Ensure Generate \hasbita{t} based on the descendants of $t$ for all nodes $t$ that can be accessed from $s$ by moving along axes $1\dots d$.
...
Algorithm~\ref{alg:sweep3d} describes the sweep.
