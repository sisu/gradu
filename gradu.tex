...
\ForAll{$d\in\set{\pm x,\pm y,\pm z}$}
	\State $E_d\gets$ Event set containing \addE at \spt with witdh and height 0, and \cellE for the cell containing \spt.
\EndFor
...
\item Merge all sequences of aligned \addEs with the same $z$-range into a single \addE.
\end{enumerate}
