...
\subsection{Laiskat puuoperaatiot}\label{sec:lazyseg}
...
Kun saavutetaan \obsevt, tapahtumaa vastaava suorakaide merkitään jälleen tyhjäksi segmenttipuussa.
Koska segmenttipuun tyhjennys vaatii lineaarisen työn, käytetään kappaleessa~\ref{sec:lazyseg} esitettyä laiskaa rakennetta.
