...
For example we can associate a number with each interval, and efficiently query for the sum or maximmum of intervals overlapping a given query interval.
