...
Alue~\sweep{A}{c} voidaan laskea pyyhkäisyalgoritmia käyttäen, joten koko kaava~\eqref{eq:reachck} voidaan evaluoida $\size{C}-1$ pyyhkäisyllä.

Yhdellä pyyhkäisyllä lasketaan.
