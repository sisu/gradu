...
We study the regular planar version as well as a three-dimensional extension of the problem.
We present a new $O(n^2\log^2 n)$ time algorithm for the three-dimensional problem, which is a significant improvement over the best previously known result $O(n^{2.5}\log n)$~\cite{restricted}.
