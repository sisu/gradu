...
\begin{algorithm}
\caption{Compute bitmask representing whether node $s$ is covered by rectangle $R$ in each direction.}\label{alg:maskof}
\begin{algorithmic}
...
\begin{algorithm}
\caption{Add rectangle $R$ to $D$-dimensional unified tree.}\label{alg:uadd}
\begin{algorithmic}
\Require \dots
\Ensure \dots
\Procedure{\adddt}{$d,s$}
