...
Vastaavasti jatkamalla pystysuoria janoja kunnes ne törmäävät vaakasuoraan esteeseen saadaan alueen \emph{pystysuora hajotelma}.
...
Tason vapaan tilan jako suorakaiteisiin.
\begin{algorithmic}
...
Perusidea tehokkaaseen reitinhakuun perustuun luvussa~\ref{sec:jako2d} esiteltyihin alueen vaakasuoraan ja pystysuoraan hajotelmaan.
...
Tarkastellaan vaakasuoran ja pystysuoran hajotelman leikkausverkkoa.
Taso voidaan jakaa suorakaiteisiin valitsemalla mikä tahansa suunta $c\in C$, ja jatkamalla $c$-suuntaisia esteiden reunoja kunnes ne törmäävät toiseen esteeseen.
