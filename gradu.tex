...
% Uudet koulutusohjelma (2017->) näkymään otsikkosivulla
\department{Tietojenkäsittelytieteen maisteriohjelma}
%\department{Datatieteen maisteriohjelma}
%\department{Tietojenkäsittelytieteen kandiohjelma}
...
Jokainen vaiheittaisen valaisun askel $k$ muodostaa alueen \reach{k+1} alueesta \reach{k}.
Jokainen alue \reachd{k+1}{c} lasketaan $\size{C}-1$ pyyhkäisyllä, lähtien kaikista joukoista \reachd{k}{d} missä $c\neq d\in C$.
Täten jokaisella askeleella suoritetaan yhteensä $\frac{\size{C}(\size{C}-1)}{2}$ pyyhkäisyä.
