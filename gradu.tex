...
\newcommand\fspace{\ensuremath{A}\xspace}
...
\reach{0} on reitin alkupiste, ja \reach{1} sitä vävistävä vaakasuora suorakaide.
Kun $k$ on pariton, voidaan \reach{k} esittää joukkona suorakaiteita, $\reach{k}=\cup_{h\in H}h$ missä $H\subseteq\decomp{x}$.
%Jokaisella parillisella askeleella \reach{2k}
