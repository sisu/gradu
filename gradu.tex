...
However the number of links in a BSP-based decomposition can be as high as $O(n^{2.5})$, so we choose to pay for the lower number of links by having a higher number of cells.
...
Segment tree is a classical data structure that allows storing and querying intervals.~\cite{unified}
