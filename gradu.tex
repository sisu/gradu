...
Figure~\ref{fig:segtree} shows an example of a segment tree.

\begin{figure}\centering
	\includegraphics[scale=0.7,page=1]{fig/segtree}
	\caption{Structure of a segment tree. The numbers show how the nodes are indexed when the tree is stored in an array.}\label{fig:segtree}
\end{figure}
