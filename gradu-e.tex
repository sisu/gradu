...
\subsection{Unified segment tree}
...
\section{Searching the intersection graph}
...
After this there is no longer any need to illuminate through $r$, so we can mark $r$ as obstacle after 2 steps have passed since the illumination first reached $k$.
