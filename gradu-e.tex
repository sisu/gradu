...
%For two \addEs to be aligned, they need to in the event set for the 
%The aligned displays are those that have identical bounds in direction $D$ and in $D-2$ of the remaining $D-1$ direction.
